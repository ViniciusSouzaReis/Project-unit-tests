const {createMenu, newCreateMenu, returnObj }= require('../src/restaurant');
...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(createMenu(object).fetchMenu).toBeInstanceOf(Function);
    ...
    // ```
    expect(createMenu(object).fetchMenu()).toBe(object);
    ...
    // ```
    expect(createMenu(object).newConsumption()).toHaveProperty('consumption', []);
    ...
    // ```
    expect(newCreateMenu('coxinha')).toHaveProperty('consumption', ['coxinha']);
